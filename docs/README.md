...
│   ├── 02_eda_analysis.ipynb       # Distribution, boxplots, correlation heatmap
│   ├── 03_risk_scoring.ipynb       # HHI, lead time variance, composite risk score
│   └── 04_monte_carlo.ipynb        # Monte Carlo simulation, dual-sourcing recommendations
│
├── sql/
